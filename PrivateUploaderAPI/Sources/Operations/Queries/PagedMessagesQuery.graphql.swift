...
public struct PagedMessagesQuery: GraphQLQuery {
  ...
  public struct Data: PrivateUploaderAPI.SelectionSet {
    ...
    public struct MessagesPaged: PrivateUploaderAPI.SelectionSet {
      ...
      @_spi(Execution) public static var __parentType: any ApolloAPI.ParentType { PrivateUploaderAPI.Objects.PaginatedMessageResponse }
      @_spi(Execution) public static var __selections: [ApolloAPI.Selection] { [
